...
const SUB_TABS: Record<string, SubTabOption[]> = {
  ...
  missions: [
    ...
    { value: 'quests', label: 'CONTRATOS', emoji: '📜' },
    { value: 'history', label: 'Crônicas Diárias', emoji: '📖' },
  ],
  kingdom: [
    { value: 'shop', label: 'Bazar de Mystara', emoji: '🪙' },
    { value: 'titles', label: 'TÍTULOS', emoji: '🎖️' },
    { value: 'heatmap', label: 'Heatmap', emoji: '📅' },
    { value: 'stats', label: 'ESTATÍSTICAS DO HERÓI', emoji: '🛡️' },
    { value: 'achievements', label: 'CONQUISTAS', emoji: '🏆' },
    { value: 'logs', label: 'REGISTROS', emoji: '📜' },
