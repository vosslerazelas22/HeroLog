  ...
  return (
    <div className="flex flex-col items-center justify-center text-center space-y-6 max-w-sm w-full py-8 select-none animate-fadeIn">
      ...
      <div className="space-y-2">
        ...
        <h1 className="text-5xl font-serif font-black text-champagne-300 drop-shadow-[0_2px_12px_rgba(226,176,84,0.4)] tracking-tight">
  ...
  return (
    <div className="w-full max-w-md py-6 select-none animate-fadeIn">
      ...
      <div className="text-center mb-6">
        <h2 className="text-champagne-400 font-serif font-black text-xl tracking-[0.15em] uppercase flex items-center justify-center gap-2">
          SESSÃO CONCLUÍDA
        </h2>
        <div className="mt-3 flex flex-col items-center justify-center gap-1">
          <span className="text-champagne-400 font-extrabold text-sm tracking-widest font-serif drop-shadow-[0_2px_8px_rgba(226,176,84,0.35)]">
      ...
      <div className="w-[85%] mx-auto space-y-4 font-serif text-xs text-[#A2A7A6] tracking-wide mb-6">
        <div className="flex justify-between items-center py-2 border-b border-amber-500/5">
          ...
          <span className="text-champagne-400 font-bold font-serif text-right">
        ...
        <div className="mt-6 bg-stone-900/40 border border-amber-500/10 rounded-lg p-4 grid grid-cols-2 gap-4 divide-x divide-amber-500/10 text-center">
          ...
          <div className="flex items-center justify-center">
            <div className="text-champagne-400 font-extrabold font-mono text-base drop-shadow-[0_2px_6px_rgba(226,176,84,0.25)]">
    ...
    <div className="w-full max-w-md py-6 select-none animate-fadeIn">
      ...
      <div className="w-[85%] mx-auto space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          {droppedTitleName && (
            <div className="bg-gradient-to-b from-champagne-600/40 via-stone-950 to-stone-950 border-champagne-500/40 shadow-[0_0_15px_rgba(229,193,88,0.15)] border p-3 rounded-lg text-left relative overflow-hidden select-none flex items-center gap-3">
              <span className="absolute top-0 left-0 w-1.5 h-1.5 border-t border-l border-champagne-500/40" />
              <span className="absolute top-0 right-0 w-1.5 h-1.5 border-t border-r border-champagne-500/40" />
              <span className="absolute bottom-0 left-0 w-1.5 h-1.5 border-b border-l border-champagne-500/40" />
              <span className="absolute bottom-0 right-0 w-1.5 h-1.5 border-b border-r border-champagne-500/40" />

              <div className="text-3xl shrink-0 select-none filter drop-shadow-[0_0_10px_rgba(229,193,88,0.4)]">
                {rewardsModalData.droppedTitleEmoji || '👑'}
              </div>

              <div className="flex-1 min-w-0 flex flex-col justify-center">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                  <h3 className="font-bold text-xs md:text-sm tracking-wide uppercase font-serif truncate text-champagne-300">
                    {droppedTitleName}
                  </h3>
                  <span className="inline-block self-start sm:self-center px-1.5 py-0.5 bg-champagne-500/10 border border-champagne-500/30 rounded text-[7px] font-mono font-bold uppercase tracking-widest text-champagne-400 leading-none">
                    ★ TÍTULO RARO ★
                  </span>
                </div>
                <p className="text-[10px] text-amber-100/50 font-serif italic truncate mt-1">
...
export function SessionNotesScreen({
  ...
  return (
    <div className="w-full max-w-md py-6 select-none animate-fadeIn">
      <div className="text-center mb-6">
        <h2 className="text-champagne-400 font-serif font-black text-lg tracking-[0.2em] uppercase">
          📜 CRÔNICA DA MISSÃO
        </h2>
        <div className="w-[85%] mx-auto border-b border-amber-500/15 mt-4" />
      </div>
      ...
      <div className="w-[85%] mx-auto space-y-6 text-left">
        <div className="space-y-1.5">
          <label className="text-[10px] uppercase font-serif font-black tracking-widest text-zinc-300 flex items-center gap-1.5 leading-none">
            ANOTAÇÕES
          </label>
          <textarea
            ...
            className="w-full bg-stone-950/85 border border-champagne-500/25 rounded-lg p-3 text-xs text-amber-200 placeholder-amber-100/25 focus:border-champagne-400 focus:outline-none custom-scrollbar resize-none font-serif h-28 shadow-inner"
          />
        </div>
                ...
                return (
                  <button
                    ...
                    className={`px-3 py-1 text-xs rounded transition-all cursor-pointer font-serif border ${
                      isSelected
                        ? 'bg-champagne-500/25 border-champagne-400 text-champagne-300 font-bold scale-[1.03] shadow-[0_0_10px_rgba(245,158,11,0.20)]'
